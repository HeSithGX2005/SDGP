...
CREATE TABLE `construction_site` (
  ...
  CONSTRAINT `construction_site_ibfk_1` FOREIGN KEY (`Company_ID`) REFERENCES `company` (`Company_ID`)
...
INSERT INTO `construction_site` VALUES (1,'Site A',1),(2,'Site B',2),(3,'Site C',3),(4,'Site D',4),(5,'Site E',5);
