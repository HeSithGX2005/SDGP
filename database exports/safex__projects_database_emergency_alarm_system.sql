...
CREATE TABLE `emergency_alarm_system` (
  ...
  CONSTRAINT `emergency_alarm_system_ibfk_1` FOREIGN KEY (`Helmet_ID`) REFERENCES `helmet` (`Helmet_ID`),
  CONSTRAINT `emergency_alarm_system_ibfk_2` FOREIGN KEY (`Employee_ID`) REFERENCES `employee` (`Employee_ID`)
...
INSERT INTO `emergency_alarm_system` VALUES (1,'Fire','Site A',1,1),(2,'Gas Leak','Site B',2,2),(3,'Fall','Site C',3,3),(4,'Injury','Site D',4,4),(5,'Accident','Site E',5,5);
